...
public class C04_SoftAssert {
    ...
    public void test1() throws InterruptedException {
        ...
        WebElement sonucYazisiElementi=driver.findElement(By.className("searchResultSummaryBar-mainText"));
        System.out.println(sonucYazisiElementi.getText());


        softAssert.assertTrue(sonucYazisiElementi.getText().contains("araba"),"sonuc yazisi araba icermiyor");
        softAssert.assertFalse(sonucYazisiElementi.getText().contains("oto"),"sonuc yazisi oto icermiyor");
