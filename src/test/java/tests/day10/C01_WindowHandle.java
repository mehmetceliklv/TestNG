...
public class C01_WindowHandle extends TestBase {
    ...
    public void test(){
        ...
        System.out.println("Ilk sayfa basligi :"+actualTitle);
        softAssert.assertEquals(actualTitle,expectedTitle,"title istenen degerden farkli");

        System.out.println("Ilk sayfanin handle degeri :"+driver.getWindowHandles());
       ...
       Set<String>tumWindowhandlelari= driver.getWindowHandles();
        ...
        System.out.println("Yeni sayfa basligi :"+actualYeniTitle);
