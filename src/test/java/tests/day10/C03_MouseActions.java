...
public class C03_MouseActions extends TestBase {
    ...
    public void test(){
        ...
        String alertYaziactual=driver.switchTo().alert().getText();
        String alertYaziexpected="You selected a context menu";
        Assert.assertEquals(alertYaziactual,alertYaziexpected,"alert yazilari ayni degil");
        ...
        Assert.assertEquals(actualIkinciSayfaYazisi,expectedIkinciSayfaYazi,"Ikinci sayfa yazisi farkli");
